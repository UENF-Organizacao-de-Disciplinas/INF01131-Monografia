...
- [ ]  Definir o que é viabilidade e inviabilidade de soluções
- [ ]  Comentar sobre começar na inviabilidade e rumar para viabilidade
- [ ]  Falar sobre soluções parciais
- [ ]  Heurísticas históricas similares às minhas
- [ ]  Remover imagem de métodos de visualização. Sinto que tá contribuindo quase nada
- [ ]  Ao explicar sobre otimização, explicar sobre alocar as variáveis evitando conflitos; Comentar também que é difícil ter a visualização completa de todos os impeditivos e que uma ferramenta de visualização vem a calhar
