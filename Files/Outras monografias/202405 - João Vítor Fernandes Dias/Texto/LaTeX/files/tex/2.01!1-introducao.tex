...
\begin{itemize}
      ...
      \item O \autoref{chap:marco} na \autopageref{chap:marco} de revisão literária informa mais detalhadamente sobre os problemas de agendamento, suas categorias, soluções, desafios e definições de termos;
