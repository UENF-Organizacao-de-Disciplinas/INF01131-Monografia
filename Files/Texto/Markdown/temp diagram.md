...
erDiagram
  Disciplinas {
    ...
    string nomeDisciplina
    string apelidoDisciplina
  }
  Professores {
    id idprofessor PK
    string laboratorio
    string curso
    string apelidoProfessor
    string nomeProfessor
  }
  Turmas {
    id idturma PK
...
erDiagram
  ...
  Disciplinas ||--o{ Turmas : "é de um"
  Turmas ||--|{ Horarios : "possui"
  Salas }|--|{ Horarios : "é alocada em"
  Disciplinas {
    id iddisciplina PK
    int periodoEsperado
    string codigoDisciplina
