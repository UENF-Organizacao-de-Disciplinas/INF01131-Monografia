...
%   \caption{Disposição inicial das disciplinas}
%   \label{fig:DistribuicaoInicial}
%   \includegraphics[width=\textwidth]{files/img/Experimentos/SituacaoInicial}
% \end{MyCenteredFigure}    % Distribuição inicial das disciplinas
...
% \begin{MyCenteredFigure}
%   \caption{Disposição aprimorada das disciplinas}
%   \label{fig:DistribuicaoAprimorada}
%   \includegraphics[width=\textwidth]{files/img/Experimentos/Aprimoramento}
% \end{MyCenteredFigure}    % Distribuição aprimorada das disciplinas
