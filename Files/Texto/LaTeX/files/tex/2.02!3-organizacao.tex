\chapter{Estrutura da instituição} \label{chap:instituicao}
...
\section{A UENF e seu estatuto} \label{sec:estatuto} % ### 4.1. A UENF e seu estatuto     % Adicionar links corretos nos laboratórios e centros
...
\section{Sequência de criação das grades horárias} \label{sec:sequencia} % ### 4.3.
