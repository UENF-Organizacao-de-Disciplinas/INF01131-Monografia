...
\section{Sequência de criação das grades horárias} \label{sec:sequencia} % ### 3.3
...
\section{Relações entre as variáveis} \label{sec:relacoes} % Mudar o nome da seção depois
