...
Para que se possa entender melhor o problema, é necessário que se entenda a estrutura organizacional da UENF disposta no \LinkToURL{https://www.uenf.br/UENF_ARQUIVOS/Downloads/REITORIA_1360_1101117875.pdf}{Estatuto da UENF}. A \LinkToURL{https://uenf.br/portal}{Universidade Estadual do Norte Fluminense Darcy Ribeiro (UENF)}, ainda que limitando ao que convém neste trabalho.
...
\begin{enumerate}
  \item Centro de Ciências do Homem - \LinkToURL{https://uenf.br/cch}{CCH};
  \item Centro de Ciência e Tecnologia - \LinkToURL{https://uenf.br/cct}{CCT};
  \item Centro de Biociências e Biotecnologia - \LinkToURL{https://uenf.br/cbb}{CBB};
  \item Centro de Ciências e Tecnologias Agropecuárias - \LinkToURL{https://uenf.br/ccta}{CCTA}.
\end{enumerate}

E também existem 8 \LinkToURL{https://uenf.br/cct/administracao/laboratorios}{laboratórios} vinculados ao Centro de Ciência e Tecnologia (CCT), sendo eles:

\begin{enumerate}
  \item Laboratório de Meteorologia – \LinkToURL{https://uenf.br/cct/lamet}{LAMET};
  \item Laboratório de Ciências Físicas – \LinkToURL{https://uenf.br/cct/lcfis}{LCFIS};
  \item Laboratório de Engenharia Civil – \LinkToURL{https://uenf.br/cct/leciv}{LECIV};
  \item Laboratório de Ciências Químicas – \LinkToURL{https://uenf.br/cct/lcqui}{LCQUI};
  \item Laboratório de Materiais Avançados – \LinkToURL{https://uenf.br/cct/lamav}{LAMAV};
  \item Laboratório de Ciências Matemáticas – \LinkToURL{https://uenf.br/cct/lcmat}{LCMAT};
  \item Laboratório de Engenharia de Produção – \LinkToURL{https://uenf.br/cct/leprod}{LEPROD};
  \item Laboratório de Engenharia e Exploração de Petróleo – \LinkToURL{https://uenf.br/cct/lenep}{LENEP}.
\end{enumerate}
...
\begin{enumerate}
  \item \LinkToURL{https://uenf.br/posgraduacao/licenciatura-matematica}{Licenciatura em Matemática};
  \item \LinkToURL{https://cc.uenf.br}{Bacharelado em Ciência da Computação};
  \item \LinkToURL{https://uenf.br/posgraduacao/matematica/apresentacao}{Mestrado Profissional em Matemática} – \LinkToURL{https://uenf.br/posgraduacao/programas/pos-graduacao-stricto-sensu}{PROFMAT} / \LinkToURL{https://www.profmat-sbm.org.br}{SBM}.
\end{enumerate}
...
O primeiro entrevistado foi o atual Diretor do CCT. Ele atualmente estrutura a relação de disciplinas ofertadas pelo CCT em Excel e as publica \LinkToURL{https://uenf.br/cct/secretaria-academica/distribuicao-das-salas-de-aula-do-cct}{em formato PDF no site do CCT}. Seu trabalho auxilia os Chefes de Laboratório e Coordenadores de Curso a visualizarem quais são as salas disponíveis e em quais horários cada professor está alocado.
...
Quanto à possibilidade de aprimoramentos no Sistema Acadêmico, ele disse que ``eu faço o que me pedem'', se referindo ao repositório do Acadêmico disponível no \LinkToURL{https://about.gitlab.com}{GitLab}, onde alguns poucos usuários fazem solicitações de alterações e melhorias. Havendo então a possibilidade de que o Coordenador de Computação faça uma solicitação à SECACAD para que seja implementada uma funcionalidade que permita a exportação dos dados necessários para o cálculo das demandas.
...
%
% Tendo obtido as informações dos \textit{stakeholders} primários, será então necessário modelar quais são as regras que ditam a estrutura organizacional em foco. Para este fim, serão utilizados diagramas conceituais utilizando \textit{softwares} de suporte como o [Visual Paradigm][LinkVisualParadigm], [draw.io][LinkDrawio] e a [ferramenta Mermaid][LinkMermaid].
