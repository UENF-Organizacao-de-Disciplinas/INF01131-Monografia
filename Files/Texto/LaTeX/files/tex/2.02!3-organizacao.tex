...
%    \includegraphics[width=\textwidth]{files/img/Forms/6.0-Opiniao-Todas}
...
%    \includegraphics[width=\textwidth]{files/img/Forms/6.5-Opiniao-Distribuida}
...
%    \includegraphics[width=\textwidth]{files/img/Forms/6.6-Opiniao-Satisfatoria}
