...
\begin{figure}[htbp]
  ...
  \includegraphics[scale=0.9]{files/img/Codificacao/DB inicial.png}
  \legend{\selfAuthor}
\end{figure}
...
\begin{figure}[htbp]
  ...
  \includegraphics[scale=0.55]{files/img/Codificacao/API-Funcionamento API.drawio.png}
  \legend{\selfAuthor}
\end{figure}
...
\begin{figure}[htbp]
  ...
  \includegraphics[scale=0.25]{files/img/Codificacao/Processamento de dados.drawio.png}
  \legend{\selfAuthor}
\end{figure}
...
\begin{figure}
  ...
  \includegraphics[scale=0.45]{./files/img/Codificacao/Conflitos/Alocação de professores.png}
  \legend{\selfAuthor}
\end{figure}
...
\begin{figure}
  ...
  \caption{Exemplo de conflito de alocação de Salas}
...
\begin{figure}[htbp]
  ...
  \includegraphics[scale=0.5]{./files/img/Codificacao/Conflitos/Paleta de Cores.png}
  \legend{\selfAuthor}
\end{figure}
...
\begin{figure}[htbp]
  ...
  \includegraphics[scale=0.27]{./files/img/Codificacao/Conflitos/Categorias Disciplinas.png}
  \legend{\selfAuthor}
\end{figure}
