...
Após a elaboração dos protótipos com o Figma, e da conceitualização diagramática do banco de dados, o desenvolvimento do sistema foi iniciado. Por maior familiaridade com a linguagem foi escolhida a linguagem JavaScript, utilizando a biblioteca \textit{React} para a criação dos componentes visuais, ou seja, o \textit{frontend}, e o \textit{Node.js} para a criação do \textit{backend} e a criação de um servidor local que permitiria visualizar as mudanças no código em tempo real. Suas logos estão ilustrados na Figura \ref{fig:frontend}.

\begin{figure}[htbp]\centering
  \caption{\label{fig:frontend} Recursos usados para o desenvolvimento do \textit{Frontend}}
...
\begin{figure}[htbp]
  \centering
  \caption{\label{fig:GitHubProjectsTable} Tabela de tarefas do GitHub Projects}
...
\begin{figure}[htbp]
  \centering
  \caption{\label{fig:API} Diagrama da progressão funcionamento da permanência dos dados}
...
% \hyperref[ModelagemBD]{modelagem anteriormente citada}
...
\begin{figure}[htbp]
  \centering
  \caption{\label{fig:ProjectsMilestones} Marcos do GitHub Projects}
...
\begin{figure}[htbp]
  \centering
  \caption{\label{fig:ProjectsLabels} Etiquetas do GitHub Projects}
...
\begin{figure}[htbp]
  \centering
  \caption{\label{fig:ProjectsInsights} Gráfico de Marco \textit{versus} quantidade de tarefas separadas por etiqueta}
