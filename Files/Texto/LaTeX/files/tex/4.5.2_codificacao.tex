...
Embora houvesse o desejo do uso de informações em formato JSON, achou-se por bem utilizar um banco de dados mais usual, recorrendo então ao MySQL. Para isso, foi necessário reformatar os dados para que pudessem ser inseridos no banco de dados.
