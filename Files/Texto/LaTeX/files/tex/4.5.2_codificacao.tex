...
\begin{figure}[htbp]\centering
  ...
  \begin{animateinline}[loop,autoplay]{1}
    \includegraphics[scale=0.2]{./files/img/Animacao/JavaScript.png}
    \includegraphics[scale=0.2]{./files/img/Animacao/NodeJS.png}
    \includegraphics[scale=0.2]{./files/img/Animacao/React.png}
    \newframe
    \includegraphics[scale=0.2]{./files/img/Animacao/NodeJS.png}
    \includegraphics[scale=0.2]{./files/img/Animacao/React.png}
    \includegraphics[scale=0.2]{./files/img/Animacao/JavaScript.png}
