...
Em seu trabalho de aplicação prática, \citeonline{miranda_udpskeduler_2012} estruturaram estágios que compõem o processo necessário para que enfim se alcance a definição de tabelas horárias ótimas.
...
O sistema final seguirá uma dinâmica similar à que foi ilustrada por \citeonline{bebis_information_2019} em seu trabalho sobre o uso da Visualização de Informações em relação às Ed-TTPs.

\begin{CenteredFigure}
  \caption{Funcionamento geral do sistema}
  \label{fig:sistema}
  \includegraphics[width=\textwidth]{files/img/2.02!4-modelagem/Arquitetura_bebis_information_2019}
  \legend{Fonte: \citeonline{bebis_information_2019}}
\end{CenteredFigure}
