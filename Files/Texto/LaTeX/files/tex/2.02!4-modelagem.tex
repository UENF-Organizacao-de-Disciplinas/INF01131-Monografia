...
Tendo esclarecido sobre as \hyperref[chap:contexto]{questões gerais da área de estudo} e de \hyperref[chap:instituicao]{como se estrutura a instituição} agora nos aprofundaremos na conceitualização do funcionamento geral do sistema e a forma como se dará a execução da \hyperref[sec:Metodologia]{metodologia proposta}.
...
\section{API REST} \label{sec:Funcionamento Geral} % 4.5
