\chapter{Contexto acadêmico} \label{chap:contexto}    % ##  2. do Problema de Tabela Horária % Underfull \hbox (badness 2460)
...
\section{Trabalhos anteriores} \label{sec:anteriores} % ### 2.4
