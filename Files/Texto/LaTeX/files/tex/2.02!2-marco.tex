...
\subsection{Divergências} \label{ssec:divergencias}         % #### 2.4.3
...
\subsubsection*{Sânya} \label{subssec:sanya} % ##### 2.4.1.1
...
\subsubsection*{Ricardo} \label{subssec:ricardo} % ##### 2.4.1.2
...
\subsubsection*{Parecer geral das divergências} \label{subssec:divergencias} % ##### 2.4.1.3
