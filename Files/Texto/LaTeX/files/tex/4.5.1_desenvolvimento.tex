...
\begin{lstlisting}[language=Python, caption={Obter demanda por extratos em PDF}, label={code:demand}]
...
\begin{MyCenteredFigure}[htbp]
  ...
  \label{fig:main}
  \includegraphics[width=\textwidth]{files/img/Prototipo/Medio/main}
...
\begin{MyCenteredFigure}
  ...
  \label{fig:CRUD_main}
  \includegraphics[width=\textwidth]{files/img/Prototipo/Medio/CRUD_main}
...
\begin{MyCenteredFigure}
  ...
  \includegraphics[width=\textwidth]{files/img/Prototipo/Medio/CRUD_salas-vazias}
...
\begin{MyCenteredFigure}
  ...
  \includegraphics[width=\textwidth]{files/img/Prototipo/Medio/CRUD_alunos}
...
\begin{MyCenteredFigure}
  ...
  \includegraphics[width=\textwidth]{files/img/Prototipo/Medio/CRUD_disciplinas}
...
\begin{MyCenteredFigure}
  ...
  \includegraphics[width=\textwidth]{files/img/Prototipo/Medio/CRUD_professores}
...
\begin{MyCenteredFigure}
  ...
  \includegraphics[width=\textwidth]{files/img/Prototipo/Medio/CRUD_turmas}
