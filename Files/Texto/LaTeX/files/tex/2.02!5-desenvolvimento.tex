...
\subsection{Andamento dos alunos} \label{subsec:andamento} % #### 5.1.1
...
\subsection{Cálculo de demanda} \label{subsec:demanda} % #### 5.1.2.
...
\section{Dados pessoais e a LGPD} \label{sec:LGPD} % ### 5.2.
...
\subsection{Protótipos de páginas} \label{subsec:páginas} % #### 5.3.1.
...
\begin{MyCenteredFigure} \caption{Página de modificação das informações de salas} \label{fig:CRUD_salas-vazias}
...
\begin{MyCenteredFigure} \caption{Página de modificação das informações de alunos} \label{fig:CRUD_alunos}
...
\begin{MyCenteredFigure} \caption{Página de modificação das informações de disciplinas} \label{fig:CRUD_disciplinas}
...
\begin{MyCenteredFigure} \caption{Página de modificação das informações de professores} \label{fig:CRUD_professores}
...
\begin{MyCenteredFigure} \caption{Página de modificação das informações de turmas} \label{fig:CRUD_turmas}
...
\begin{MyCenteredFigure} \caption{Recursos usados para o desenvolvimento do \textit{Frontend}} \label{fig:frontend}
...
\subsection{Primeira Versão} \label{subsec:MVP1} % ### 5.5.2. Primeira versão
...
\subsubsection{Banco de Dados Primitivo} \label{sssec:BDInicial}
...
\subsection{Segunda Versão} \label{subsec:MVP2} % ### 5.5.3. Segunda versão
...
\subsubsubsection*{\LinkToURL{\LinkJSONBin}{JSONBin}} \label{\LinkToURL{\LinkJSONBin}{JSONBin}}
...
\subsubsubsection*{MySQL} \label{MySQL}
...
\begin{MyCenteredFigure} \caption{Diagrama primitivo das tabelas de dados SQL} \label{fig:TabelasIniciais}
...
\subsubsection{\textit{Amazon Web Services}} \label{sssec:\textit{Amazon Web Services}}
...
\subsubsubsection*{Implantação} \label{Implantação}
...
\subsubsubsection*{AWS CLI} \label{AWS CLI}
...
\subsubsubsection*{SAM} \label{SAM}
...
\subsubsection{Funcionalidades Adicionais} \label{sssec:Funcionalidades Adicionais}
...
\subsection{Terceira Versão} \label{subsec:MVP3} % ### 5.5.3.
...
\subsubsubsection*{Marcos e Etiquetas} \label{Marcos e Etiquetas}
...
\begin{MyCenteredFigure} \caption{Marcos do GitHub Projects} \label{fig:ProjectsMilestones}
...
\subsubsubsection*{Gráficos} \label{Gráficos}
...
\subsubsubsection*{Filtros e ordenações} \label{Filtros e ordenações}
...
\subsubsubsection*{MultiTurmas} \label{MultiTurmas}
...
\subsubsubsection*{Grade Horária} \label{Grade Horária}
...
\subsubsubsection*{Banco de dados} \label{Banco de dados}
...
\subsubsubsection*{Gerais} \label{Gerais}
...
\section{Conflitos} \label{sec:conflitos} % ### 5.6.
