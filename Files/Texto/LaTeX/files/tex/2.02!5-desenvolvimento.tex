...
\begin{MyCenteredFigure} \caption{Diagrama do fluxo de obtenção de dados} \label{fig:DataFlow}
  \includegraphics[width=\textwidth]{files/img/2.02!5-desenvolvimento/2.02!5.1.6-preenchimento/Processamento de dados}
\end{MyCenteredFigure}
...
\subsection{Funcionalidades preparadas} \label{ssec:Funcionalidades preparadas}
...
\begin{MyCenteredFigure} \caption{Diagrama entidade relacionamento final} \label{fig:DER final}
  \includegraphics[width=\textwidth]{files/img/2.02!5-desenvolvimento/2.02!5.1.4-sistema/diagramas/Diagrama ER-Final}
\end{MyCenteredFigure}
