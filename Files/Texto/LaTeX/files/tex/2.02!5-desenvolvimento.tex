...
\begin{MyCenteredFigure}
  ...
  \label{fig:API}
  \includegraphics[width=\textwidth]{files/img/2.02!5-desenvolvimento/2.02!5.1.4-sistema/API-Progressão.drawio}
\end{MyCenteredFigure}
...
\begin{MyCenteredFigure}
  ...
  \includegraphics[width=0.7\textwidth]{files/img/2.02!5-desenvolvimento/2.02!5.1.4-sistema/Diagrama_ER-As_is.drawio}
\end{MyCenteredFigure}
...
\begin{MyCenteredFigure}
  ...
  \includegraphics[width=0.7\textwidth]{files/img/2.02!5-desenvolvimento/2.02!5.1.4-sistema/GitHubProjects-Labels}
\end{MyCenteredFigure}
