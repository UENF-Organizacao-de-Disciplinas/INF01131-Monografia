...
\subsubsection{Banco de Dados Inicial} \label{sssec:BDInicial}
...
\subsubsection{Funcionalidades Iniciais: CRUD, primeiros conflitos e abandonadas} \label{sssec:Funcionalidades Iniciais}
